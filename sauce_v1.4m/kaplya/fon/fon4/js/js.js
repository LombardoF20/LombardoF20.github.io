...
$(document).ready(function() {
  ...
  var gContext,
    ...
    gFade,
    gFont,
    gFontHeight, // Fade speed and font size
    gStreams, // the number of streams of letters to draw
    gY,
    gYTerm,
    gFillColor, // Arrays and color for our main stream of letters
    gYSlow,
    gYTermSlow,
    gSlowCycle,
    gCurrentSlowCycle,
    gSlowFillColor, // Arrays, color and render speed of our slow stream of letters
    gTerminateHeight,
    gTerminateAddHeight; // When we kill the streams
