<?php
/*
Template Name: Записи Акция UA
Template Post Type: post, page, product
*/
get_header('ua'); ?>

<link rel="stylesheet" href="/wp-content/themes/ekvatoria/css/akcziya.css">
			...
			<div id="primary" class="container">
				...
				while ( have_posts() ) :
					...
					get_template_part( 'template-parts/contentSinglAkcziya', 'page' );
